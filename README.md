...
/api/subscribe -- to subscribe to a website this requires a website ID and user id(this data can be gotten from the db )<br>
PHP artisan queue worker to run the queued jobs</p>
